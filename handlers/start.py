...
HELP_TEXT = (
    ...
    "📊 <b>Статистика</b>\n"
    "Аналитика: график по выбранному периоду и показателю, связи между метриками "
    "и короткие инсайты. Период и метрику можно переключать кнопками под сообщением.\n\n"
